...
<template>
    ...
    <div class="relative min-h-screen bg-background text-foreground">
        ...
        />
        <div class="relative mx-auto flex min-h-screen max-w-6xl flex-col px-6 py-6">
            ...
            <main class="grid flex-1 items-center gap-12 py-16 lg:grid-cols-[1.1fr_0.9fr]">
                <div class="space-y-6">
                    ...
                    <h1 class="max-w-xl text-4xl leading-tight font-semibold md:text-6xl">
                        {{ trans('welcome.headline') }}
                    </h1>
                    <p class="max-w-lg text-base text-muted-foreground md:text-lg">
                        {{ trans('welcome.body') }}
                    </p>
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div class="rounded-3xl border bg-card p-5 shadow-sm">
                        ...
                        <h2 class="font-medium">{{ trans('welcome.qr_title') }}</h2>
                    ...
                    <div class="rounded-3xl border bg-card p-5 shadow-sm">
                        ...
                        <h2 class="font-medium">{{ trans('welcome.site_title') }}</h2>
                        <p class="mt-2 text-sm text-muted-foreground">
                    ...
                    <div class="rounded-3xl border bg-card p-5 shadow-sm">
                        ...
                        <h2 class="font-medium">{{ trans('welcome.role_title') }}</h2>
                        <p class="mt-2 text-sm text-muted-foreground">
                    ...
                    <div class="rounded-3xl border bg-card p-5 shadow-sm">
                        ...
                        <h2 class="font-medium">{{ trans('welcome.tasks_title') }}</h2>
                        <p class="mt-2 text-sm text-muted-foreground">
