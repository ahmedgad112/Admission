        ...
        <div class="flex items-center gap-4">
            ...
            <div class="space-y-1">
                ...
                <p class="text-muted-foreground text-sm">
                    {{
                        trans('settings.security.passkeys.added', {
                    ...
                    <template v-if="passkey.last_used_at_diff">
                        ...
                        {{
                            trans('settings.security.passkeys.last_used', {
        ...
        <Dialog>
            <DialogTrigger as-child>
                ...
                >
                    ...
                    <span class="sr-only">{{
                        trans('settings.security.passkeys.remove')
                    }}</span>
                </Button>
            </DialogTrigger>
            ...
            <DialogContent>
                <DialogTitle>{{
                    trans('settings.security.passkeys.remove_title')
                }}</DialogTitle>
                <DialogDescription>
                    {{
                        trans('settings.security.passkeys.remove_body', {
                            name: passkey.name,
                        })
                    }}
                </DialogDescription>
                <DialogFooter class="gap-2">
                    ...
                    >
                        {{
                            isDeleting
                                ? trans('settings.security.passkeys.removing')
                                : trans(
                                      'settings.security.passkeys.remove_confirm',
                                  )
                        }}
                    </Button>
                </DialogFooter>
